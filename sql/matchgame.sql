...
(1, 'Trey', 'Smith', 'leontrey777@gmail.com', 'leon', 'leon', '2018-06-05 19:06:10');
...
INSERT INTO `scores` (`IDscore`, `memberID`, `score`, `seconds`, `attempts`, `matches`, `average`, `dateTime`) VALUES
(1, 1, 12345, 135, 36, 12, 0.333, '2018-06-05 19:37:35'),
(2, 1, 12345, 135, 36, 12, 0.333, '2018-06-05 19:37:37');
...
--
ALTER TABLE `scores`
  MODIFY `IDscore` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
